...
for(i31=0;i31<7;++i31){
  /* There are 7 combinations of i31 that reach this block */

	//printf("Computation of K: %d SHIFT: %d is %d%% complete\n", K, SHIFT, (i31*100)/7);
...
// elements in vector arrays are stored IN REVERSE ORDER in SSE2!
